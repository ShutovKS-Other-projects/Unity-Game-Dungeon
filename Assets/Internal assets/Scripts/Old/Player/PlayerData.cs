...
namespace Old.Player
{
    ...
    {
        [Header("Player Stats")] public string className = "No one";
        public float experience = 0f;

        [Header("Health")] public float healthMax = 100f;
        ...
        [Header("Attributes")] public float agility = 10f;
        public float strength = 10f;
        public float armor = 10f;

        [Header("CriticalDamage")] public float criticalDamage = 25f;
        public float criticalChance = 15f;

        [Header("Magic")] public float magicStrength = 10f;
